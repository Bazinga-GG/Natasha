<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelUpload</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelUploadIFrame" id="page4MarvelUploadIFrame" src="static/jsdoc/module-MarvelUpload.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelUploadIFrame.setIframe4DemoPage();
      },
