<template>
  <div class="widgetShowSession">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelDevPanelIFrame" id="page4MarvelDevPanelIFrame" src="static/jsdoc/module-MarvelDevPanel.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelDevPanelIFrame.setIframe4DemoPage();
