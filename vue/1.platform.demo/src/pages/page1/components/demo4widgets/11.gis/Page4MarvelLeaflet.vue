<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelLeaflet</div>
    <div class="describe">
    ...
    methods: {
      ...
      oTestData: function () {
        ...
        arrNodes.push({
          ...
          y: -0.09,
          uiType: "ne",
          uiImgUrl: "/static/image/gis/node1.svg",
          uiImgWidth: 32,
          uiLabel: "marker1",
        ...
        arrNodeGroups.push({
          ...
          uiType: "site",
          uiImgUrl: "/static/image/gis/nodeGroup1.svg",
          uiImgWidth: 32,
          uiLabel: "site1",
        ...
        this.$refs.ref0.addMarker("marker3", 51.5, -0.08, "/static/image/gis/node1.svg", 32, {
          id: "marker3",
          x: 51.5,
          y: -0.08,
          uiType: "ne",
      ...
      oTest4Marker: function () {
        ...
        this.$refs.ref0.setImgUrl("marker1", "/static/image/gis/nodeGroup1.svg", 32);
      ...
      oTest4AttachedIcon: function () {
        var self = this;
        this.$refs.ref0.addAttachedIcon4Marker("marker1", "/static/image/gis/location-01.svg");
        setTimeout(function () {
